...
if("FALSE" STREQUAL "TRUE")
  set(effort_controllers_SOURCE_PREFIX /home/xu/Desktop/github_ws/src/UR_with_Robotiq_grasp_gazebo/depends/ros_controllers/effort_controllers)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'effort_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xu/Desktop/github_ws/install/${idir}'.  ${_report}")
    endif()
