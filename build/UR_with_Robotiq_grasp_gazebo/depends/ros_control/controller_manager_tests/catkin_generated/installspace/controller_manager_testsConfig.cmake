...
if("FALSE" STREQUAL "TRUE")
  set(controller_manager_tests_SOURCE_PREFIX /home/xu/Desktop/github_ws/src/UR_with_Robotiq_grasp_gazebo/depends/ros_control/controller_manager_tests)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xu/Desktop/github_ws/install/${idir}'.  ${_report}")
    endif()
