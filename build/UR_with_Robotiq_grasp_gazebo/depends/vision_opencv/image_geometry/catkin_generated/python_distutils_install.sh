...
echo_and_run cd "/home/xu/Desktop/github_ws/src/UR_with_Robotiq_grasp_gazebo/depends/vision_opencv/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/xu/Desktop/github_ws/src/UR_with_Robotiq_grasp_gazebo/depends/vision_opencv/image_geometry/setup.py" \
    build --build-base "/home/xu/Desktop/github_ws/build/UR_with_Robotiq_grasp_gazebo/depends/vision_opencv/image_geometry" \
    install \
    $DESTDIR_ARG \
