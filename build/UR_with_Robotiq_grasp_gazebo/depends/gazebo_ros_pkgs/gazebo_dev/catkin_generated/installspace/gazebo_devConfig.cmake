...
if("FALSE" STREQUAL "TRUE")
  set(gazebo_dev_SOURCE_PREFIX /home/xu/Desktop/github_ws/src/UR_with_Robotiq_grasp_gazebo/depends/gazebo_ros_pkgs/gazebo_dev)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_dev' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xu/Desktop/github_ws/install/${idir}'.  ${_report}")
    endif()
