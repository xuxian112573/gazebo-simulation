...
if("FALSE" STREQUAL "TRUE")
  set(gazebo_msgs_SOURCE_PREFIX /home/xu/Desktop/github_ws/src/UR_with_Robotiq_grasp_gazebo/depends/gazebo_ros_pkgs/gazebo_msgs)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xu/Desktop/github_ws/install/${idir}'.  ${_report}")
    endif()
