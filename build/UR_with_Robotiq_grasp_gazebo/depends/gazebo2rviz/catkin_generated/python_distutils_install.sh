...
echo_and_run cd "/home/xu/Desktop/github_ws/src/UR_with_Robotiq_grasp_gazebo/depends/gazebo2rviz"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/xu/Desktop/github_ws/src/UR_with_Robotiq_grasp_gazebo/depends/gazebo2rviz/setup.py" \
    build --build-base "/home/xu/Desktop/github_ws/build/UR_with_Robotiq_grasp_gazebo/depends/gazebo2rviz" \
    install \
    $DESTDIR_ARG \
